...
_G.packer_plugins = {
  ...
  ["blamer.nvim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/blamer.nvim",
  ...
  ["editorconfig-vim"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/editorconfig-vim",
  ...
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/home/user/.local/share/nvim/site/pack/packer/start/vim-airline-themes",
